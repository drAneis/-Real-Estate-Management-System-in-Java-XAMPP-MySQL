...
public class SignupActivity extends JFrame implements ActionListener {
	...
	public SignupActivity() {
		...
		title = new JLabel("登记"); //antes sign up
		...
		buttonBack = new JButton("返回"); //antes back
		...
		buttonSubmit = new JButton("提交"); //antes submit
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonExit))
			...
			try {
				...
				JOptionPane.showMessageDialog(this,"请输入正确手机号!"); //Enter Phone number corectly
			}
