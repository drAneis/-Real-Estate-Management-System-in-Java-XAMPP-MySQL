...
public class AddEmployeeActivity extends JFrame implements ActionListener {
	...
	public AddEmployeeActivity(ViewEmployeeActivity prev, Employee employee) {
		...
		employeePhoneTF1 = new JTextField("+86");
